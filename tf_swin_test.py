...
file = sio.loadmat('sat-4-full.mat')
...
x_train = np.transpose(x_train[:,:,:3,:], [3, 0, 1, 2])[0:50000]
x_test = np.transpose(x_test[:,:,:3,:], [3, 0, 1, 2])[0:12500]

y_train = np.transpose(y_train)[0:50000]
y_test = np.transpose(y_test)[0:12500]
